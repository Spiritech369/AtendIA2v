...
DEMO_VEHICLES: list[dict] = [
    ...
    },
    {
        ...
        "label": "Saveiro 2024",
        "status": "maintenance",
        "available_for_test_drive": False,
    },
]
...
DEMO_HUMAN_AGENTS: list[dict] = [
    {
        ...
        "status": "online",
        "max_active_cases": 8,
        "skills": ["facturacion", "documentos", "credito"],
        "current_workload": 2,
    },
    {
        "id": "carlos-mendez",
        ...
        "status": "online",
        "max_active_cases": 12,
        "skills": ["negociacion", "ventas", "cierre"],
        "current_workload": 3,
    },
    {
        "id": "mariana-vega",
    ...
    },
    {
        ...
        "status": "online",
        "max_active_cases": 10,
        "skills": ["agenda", "disponibilidad", "sucursal"],
        "current_workload": 4,
    },
    {
        "id": "paola-nava",
        ...
        "status": "online",
        "max_active_cases": 6,
        "skills": ["sla", "quejas", "alto_valor"],
        "current_workload": 1,
    },
    {
        "id": "diego-ai",
        "name": "Diego Salas",
        "email": "diego.ai@demo.com",
        "role": "ai_supervisor",
        "status": "online",
        "max_active_cases": 8,
        "skills": ["kb", "routing", "training"],
        "current_workload": 2,
    },
]
