...
AI_AGENTS = [
    ...
    },
    {
        "id": "agenda-bot",
        "name": "Agenda Bot",
        "purpose": "Citas y disponibilidad",
        "confidence_avg": 0.81,
    ...
    },
    {
        "id": "kb-general",
        "name": "KB General",
        "purpose": "FAQs y soporte general",
        "confidence_avg": 0.76,
...
SEED_HANDOFFS = [
    {
        "customer": "Maria Fernanda Lopez",
        "phone": "+52 55 4422 8811",
        "reason": "Factura fiscal / Datos incorrectos",
        "message": "Necesito una factura fiscal con mis datos correctos, ya van dos veces que me la mandan mal.",
        "intent": "facturacion",
        "confidence": 0.23,
        "wait": 32,
        "value": 12580,
        ...
        "sentiment": "negative",
        "agent": None,
        "suggested": "Andrea Ruiz",
        "ai_agent": "Ventas Pro",
        "missing": ["RFC o razon social", "Uso de CFDI"],
        "rule": "R-INV-03: Solicitud de intervencion humana + errores de datos fiscales",
    },
    {
        "customer": "Juan Carlos Ramirez",
        "phone": "+52 81 2345 6789",
        "reason": "Negociacion de precio",
        "message": "¿Pueden igualar el precio de la competencia? Si me respetan eso cierro hoy.",
        "intent": "descuento",
        "confidence": 0.45,
        "wait": 14,
        "value": 24900,
        ...
        "sentiment": "neutral",
        "agent": "Carlos Mendez",
        "suggested": "Carlos Mendez",
        "ai_agent": "Ventas Pro",
        "missing": ["Autorizacion de descuento"],
        "rule": "R-SALES-07: Solicitud de descuento fuera de politica automatica",
    },
    {
        "customer": "Ana Sofia Herrera",
        "phone": "+52 33 9988 7766",
        "reason": "Disponibilidad / Agenda",
        "message": "¿Tienen disponibilidad para instalar este sabado? Solo puedo ir en la tarde.",
        "intent": "agenda",
        "confidence": 0.68,
        "wait": 9,
        "value": 8450,
        ...
        "sentiment": "positive",
        "agent": None,
        "suggested": "Luis Ortega",
        "ai_agent": "Agenda Bot",
        "missing": ["Sucursal preferida", "Horario exacto"],
        "rule": "R-AGENDA-02: Excepcion de horario requiere confirmacion humana",
    },
    {
        "customer": "Roberto Fernandez",
        "phone": "+52 55 6677 8899",
        "reason": "Error de sistema / Pago",
        "message": "No pude completar mi pago, me da error 503 y ya me urge apartar la moto.",
        "intent": "pago_fallido",
        "confidence": 0.52,
        "wait": 6,
        "value": 11290,
        ...
        "sentiment": "negative",
        "agent": "Mariana Vega",
        "suggested": "Mariana Vega",
        "ai_agent": "Soporte Pagos",
        "missing": ["Referencia de pago", "Captura del error"],
        "rule": "R-PAY-01: Error tecnico + frustracion del cliente + reintentos fallidos",
    },
    {
        "customer": "Daniela Torres",
        "phone": "+52 81 9090 1212",
        "reason": "Documentos incompletos",
        "message": "Ya subi mi INE pero no tengo comprobante a mi nombre, ¿que hago?",
        "intent": "documentos_credito",
        "confidence": 0.31,
        "wait": 21,
        "value": 18200,
        "stage": "Documentos",
        ...
        "suggested": "Andrea Ruiz",
        "ai_agent": "Credito IA",
        "missing": ["Comprobante de domicilio", "Validacion de titular"],
        "rule": "R-DOC-04: Documento faltante con excepcion de politica",
    },
    {
        "customer": "Hector Molina",
        "phone": "+52 55 7000 1000",
        "reason": "Cliente pidio humano",
        "message": "Pasame con alguien real, el bot no entiende lo de mi enganche.",
        "intent": "humano",
        "confidence": 0.38,
        "wait": 18,
        "value": 15890,
        "stage": "Enganche listo",
        "sentiment": "negative",
        "agent": None,
        "suggested": "Paola Nava",
        "ai_agent": "Credito IA",
        "missing": ["Monto de enganche", "Plan credito"],
        "rule": "R-HUM-01: Cliente solicita humano explicitamente",
    },
    {
        "customer": "Valeria Cano",
        "phone": "+52 33 1212 3434",
        "reason": "Baja confianza IA",
        "message": "¿Si estoy en buro puedo sacar la Dinamo R1 con nomina en efectivo?",
        "intent": "credito_buro",
        "confidence": 0.19,
        "wait": 26,
        "value": 21990,
        ...
        "suggested": "Andrea Ruiz",
        "ai_agent": "Credito IA",
        "missing": ["Tipo de ingreso", "Score buro", "Plan credito"],
        "rule": "R-AI-LOW-02: Confianza menor a 30% en credito",
    },
    {
        "customer": "Miguel Angel Prieto",
        "phone": "+52 81 8080 7070",
        "reason": "Fuera de horario",
        "message": "Estoy afuera de la sucursal, ¿si alcanzo a dejar papeles?",
        "intent": "horario_sucursal",
        "confidence": 0.63,
        "wait": 43,
        "value": 9300,
        "stage": "Documentos",
        ...
        "suggested": "Luis Ortega",
        "ai_agent": "Agenda Bot",
        "missing": ["Sucursal", "Horario real"],
        "rule": "R-AH-01: Mensaje fuera de horario con visita presencial",
    },
    {
        "customer": "Lucia Martinez",
        "phone": "+52 55 1001 2002",
        "reason": "Queja o frustracion",
        "message": "Llevo tres dias esperando respuesta, si no me ayudan cancelo.",
        "intent": "queja",
        "confidence": 0.34,
        "wait": 52,
        "value": 26600,
        ...
        "suggested": "Paola Nava",
        "ai_agent": "KB General",
        "missing": ["Historial de promesa", "Responsable anterior"],
        "rule": "R-SENT-09: Sentimiento negativo + amenaza de cancelacion",
    },
    {
        "customer": "Oscar Ibarra",
        "phone": "+52 33 6000 7000",
        "reason": "Pregunta no encontrada en KB",
        "message": "¿Puedo facturar a una empresa de otro estado con entrega en Monterrey?",
        "intent": "facturacion_foranea",
        "confidence": 0.28,
        "wait": 11,
        "value": 14100,
        "stage": "Nuevo",
        "sentiment": "neutral",
        "agent": None,
        "suggested": "Diego Salas",
        "ai_agent": "KB General",
        "missing": ["Politica fiscal foranea"],
        "rule": "R-KB-404: No hay respuesta confiable en conocimiento",
    },
    {
        "customer": "Nadia Flores",
        "phone": "+52 81 4545 4545",
        "reason": "Disponibilidad / Agenda",
        "message": "Quiero apartar la Dinamo U5 hoy, ¿sigue disponible en negro?",
        "intent": "stock_color",
        "confidence": 0.57,
        "wait": 4,
        "value": 17800,
        ...
        "suggested": "Luis Ortega",
        "ai_agent": "Ventas Pro",
        "missing": ["Stock por color", "Sucursal"],
        "rule": "R-STOCK-01: No inventar disponibilidad",
    },
    {
        "customer": "Rafael Cordero",
        "phone": "+52 55 9099 8888",
        "reason": "Documentos incompletos",
        "message": "Me pagan en efectivo y no tengo nomina, pero si puedo dar enganche.",
        "intent": "credito_efectivo",
        "confidence": 0.42,
        "wait": 39,
        "value": 20400,
        "stage": "Documentos",
        ...
        "suggested": "Andrea Ruiz",
        "ai_agent": "Credito IA",
        "missing": ["Comprobante ingresos", "Enganche confirmado"],
        "rule": "R-CREDIT-12: Caso de ingreso no estandar",
    },
    {
        "customer": "Patricia Salas",
        "phone": "+52 33 2010 5566",
        "reason": "Error de sistema / Pago",
        "message": "Me cobraron dos veces el apartado, necesito solucion hoy.",
        "intent": "doble_cargo",
        "confidence": 0.25,
        "wait": 7,
        "value": 10990,
        ...
        "suggested": "Paola Nava",
        "ai_agent": "Soporte Pagos",
        "missing": ["Referencia bancaria", "Ultimos 4 digitos"],
        "rule": "R-PAY-CRIT: Doble cargo reportado",
    },
    {
        "customer": "Emilio Rivas",
        "phone": "+52 81 7777 1212",
        "reason": "Negociacion de precio",
        "message": "Si me incluyen casco y placas, firmo hoy con transferencia.",
        "intent": "paquete_cierre",
        "confidence": 0.49,
        "wait": 16,
        "value": 31400,
        "stage": "Cerrado",
        ...
        "suggested": "Carlos Mendez",
        "ai_agent": "Ventas Pro",
        "missing": ["Autorizacion paquete", "Disponibilidad placas"],
        "rule": "R-CLOSE-04: Condicion comercial para cierre",
    },
    {
        "customer": "Gabriela Mejia",
        "phone": "+52 55 3030 4040",
        "reason": "Baja confianza IA",
        "message": "¿Aceptan INE de otro estado y comprobante de mi tia?",
        "intent": "ine_comprobante",
        "confidence": 0.22,
        "wait": 28,
        "value": 18700,
        "stage": "Documentos",
        ...
        "suggested": "Diego Salas",
        "ai_agent": "Credito IA",
        "missing": ["Regla INE foranea", "Comprobante tercero"],
        "rule": "R-AI-LOW-02 + posible conflicto de KB",
    },
    {
        "customer": "Tomas Beltran",
        "phone": "+52 33 4444 1212",
        "reason": "Queja o frustracion",
        "message": "El asesor me dejo en visto y el bot me repite lo mismo.",
        "intent": "abandono_asesor",
        "confidence": 0.41,
        "wait": 24,
        "value": 13600,
        "stage": "Cita",
        ...
        "suggested": "Paola Nava",
        "ai_agent": "KB General",
        "missing": ["Asesor responsable"],
        "rule": "R-SENT-07: Frustracion + transferencia humana necesaria",
    },
    {
        "customer": "Renata Vega",
        "phone": "+52 81 1212 2020",
        "reason": "Pregunta no encontrada en KB",
        "message": "¿La garantia cubre bateria si uso la moto para reparto?",
        "intent": "garantia_reparto",
        "confidence": 0.36,
        "wait": 19,
        "value": 16700,
        "stage": "Nuevo",
        ...
        "suggested": "Diego Salas",
        "ai_agent": "KB General",
        "missing": ["Cobertura de garantia para reparto"],
        "rule": "R-KB-404: Tema no cubierto",
    },
    {
        "customer": "Jose Luis Acosta",
        "phone": "+52 55 7788 9900",
        "reason": "Fuera de horario",
        "message": "Puedo ir ahorita con el enganche, pero no se si hay alguien.",
        "intent": "visita_fuera_horario",
        "confidence": 0.59,
        "wait": 35,
        "value": 22200,
        "stage": "Enganche listo",
        ...
        "suggested": "Luis Ortega",
        "ai_agent": "Agenda Bot",
        "missing": ["Sucursal abierta", "Asesor disponible"],
        "rule": "R-AH-01: Cierre potencial fuera de horario",
    },
    {
        "customer": "Brenda Pacheco",
        "phone": "+52 33 7070 8080",
        "reason": "Cliente pidio humano",
        "message": "Necesito hablar con supervisor por mi cita cancelada.",
        "intent": "supervisor_cita",
        "confidence": 0.46,
        "wait": 13,
        "value": 11900,
        "stage": "Cita",
        ...
        "suggested": "Paola Nava",
        "ai_agent": "Agenda Bot",
        "missing": ["Motivo cancelacion"],
        "rule": "R-HUM-02: Solicitud de supervisor",
    },
    {
        "customer": "Alonso Neri",
        "phone": "+52 81 5050 6060",
        "reason": "Factura fiscal / Datos incorrectos",
        "message": "El RFC salio mal y contabilidad ya me esta presionando.",
        "intent": "correccion_factura",
        "confidence": 0.33,
        "wait": 22,
        "value": 15400,
        "stage": "Sistema",
        ...
        "suggested": "Andrea Ruiz",
        "ai_agent": "Soporte Pagos",
        "missing": ["RFC correcto", "Regimen fiscal"],
        "rule": "R-INV-03: Correccion fiscal requiere humano",
    },
]
...
def _score_handoff(
    *,
    ...
    return PriorityBreakdown(
        score=score, urgency=_urgency_from_score(score), explanation=explanation[:5]
    )
...
def _risk_level(
    score: int, sla_status: SlaStatus, sentiment: str
...
def _seed_to_item(spec: dict, tenant_id: UUID, index: int, now: datetime) -> HandoffCommandItem:
    ...
    return HandoffCommandItem(
        ...
        knowledge_gap_topic=str(spec["intent"])
        if "KB" in spec["reason"] or "Baja confianza" in spec["reason"]
        else None,
...
def _db_to_item(
    ...
    name = str(
        _payload_value(payload, "customer", None) or customer.name
        if customer and customer.name
        else "Cliente sin nombre"
    )
    last_message = str(
        _payload_value(payload, "last_inbound", None)
        or _payload_value(payload, "last_inbound_text", None)
        or row.reason
    )
    reason = str(
        _payload_value(payload, "handoff_reason", None)
        or _payload_value(payload, "reason_code", None)
        or row.reason
    )
    confidence = float(_payload_value(payload, "ai_confidence", 0.46) or 0.46)
    stage = str(
        _payload_value(payload, "lifecycle_stage", None)
        or (customer.stage if customer else None)
        or (conversation.current_stage if conversation else "Nuevo")
    )
    sentiment = str(
        _payload_value(payload, "sentiment", None) or (customer.attrs or {}).get("sentiment")
        if customer
        else "neutral"
    )
    if sentiment not in ("positive", "neutral", "negative"):
        sentiment = "neutral"
    value = int(
        _payload_value(payload, "estimated_value", None)
        or (customer.attrs or {}).get("estimated_value", 14500)
        if customer
        else 14500
    )
    missing = list(
        _payload_value(payload, "missing_fields", None)
        or _payload_value(payload, "docs_pendientes", None)
        or []
    )
    ...
    return HandoffCommandItem(
        ...
        customer_id=str(
            ...
            if conversation
            else _stable_uuid(tenant_id, "customer", row.id)
        ),
        customer_name=name,
        phone=str(
            customer.phone_e164
            if customer
            else _payload_value(payload, "phone", "+52 55 0000 0000")
        ),
        channel=str(conversation.channel if conversation else "WhatsApp"),
        status=row.status
        if row.status in ("open", "assigned", "resolved", "escalated")
        else "open",
        priority_score=score.score,
        ...
        detected_intent=str(
            _payload_value(
                payload,
                "detected_intent",
                _payload_value(payload, "last_intent", "intervencion_humana"),
            )
        ),
        ai_confidence=confidence,
        wait_time_seconds=wait_seconds,
        ...
        recommended_action=str(
            _payload_value(
                ...
                "recommended_action",
                _payload_value(
                    payload, "suggested_next_action", "Tomar control y validar datos pendientes."
                ),
            )
        ),
        suggested_reply=str(
            _payload_value(
                payload, "suggested_reply", _draft_for({"customer": name, "reason": reason})
            )
        ),
        why_triggered=str(
            _payload_value(
                payload,
                "why_triggered",
                f"{row.reason}. El bot detecto que continuar automaticamente podria ser riesgoso.",
            )
        ),
        risk_level=risk_level,
        risk_explanation=str(
            _payload_value(
                payload, "risk_explanation", "Riesgo de mala experiencia o respuesta no trazable."
            )
        ),
        missing_fields=missing,
        ...
        assigned_agent_name=str(_payload_value(payload, "assigned_agent_name", None))
        ...
        related_history=list(
            _payload_value(
                payload, "related_history", ["Conversacion activa", "Historial de IA disponible"]
            )
        ),
        knowledge_gap_topic=_payload_value(payload, "knowledge_gap_topic", None),  # type: ignore[arg-type]
        ai_rule=str(
            _payload_value(payload, "ai_rule", "R-HUMAN-HANDOFF: escalacion generada por el runner")
        ),
    )


async def _load_db_items(
...
async def _load_human_agents(
    session: AsyncSession, tenant_id: UUID, items: list[HandoffCommandItem]
) -> list[HumanAgent]:
    ...
    for item in items:
        if item.assigned_user_id and item.status != "resolved":
            workload_by_user[item.assigned_user_id] = (
                workload_by_user.get(item.assigned_user_id, 0) + 1
            )
...
def _build_items_with_seed(
    db_items: list[HandoffCommandItem], tenant_id: UUID, now: datetime
) -> list[HandoffCommandItem]:
    items = list(db_items)
    ...
    *,
    ...
    if agent and agent != "all":
        out = [
            item
            for item in out
            if item.assigned_user_id == agent
            or item.suggested_agent_name == agent
            or item.assigned_agent_name == agent
        ]
    ...
    if ai_agent and ai_agent != "all":
        out = [
            item for item in out if item.ai_agent_id == ai_agent or item.ai_agent_name == ai_agent
        ]
...
def _insights(items: list[HandoffCommandItem]) -> list[InsightCard]:
    ...
    return [
        InsightCard(
            id="reason",
            label="Razon mas comun hoy",
            value=top_reason,
            detail=f"{reasons.get(top_reason, 0)} handoffs",
            trend="+34% vs ayer",
            sparkline=[2, 2, 4, 5, 4, 7, 8, 11, 8, 12],
            tone="info",
        ),
        InsightCard(
            id="ai-agent",
            label="Agente IA con mas escalaciones",
            value=top_ai,
            detail=f"{agents.get(top_ai, 0)} handoffs",
            trend="+18%",
            sparkline=[3, 4, 3, 6, 5, 9, 8, 7, 10, 9],
            tone="warning",
        ),
        InsightCard(
            id="slowest",
            label="Cola mas lenta",
            value="Facturacion",
            detail="Prom. 28m 36s",
            trend="+6m",
            sparkline=[4, 5, 6, 6, 8, 9, 12, 13, 14, 16],
            tone="critical",
        ),
        InsightCard(
            id="kb-gap",
            label="Brecha de conocimiento",
            value="Politica de descuentos",
            detail="12 consultas sin respuesta",
            trend="+5",
            sparkline=[1, 1, 2, 2, 4, 4, 7, 6, 9, 10],
            tone="warning",
        ),
        InsightCard(
            id="after-hours",
            label="Pico fuera de horario",
            value="+38%",
            detail="7 PM - 11 PM",
            trend="+11 PM",
            sparkline=[1, 2, 1, 2, 3, 3, 6, 8, 9, 11],
            tone="info",
        ),
        InsightCard(
            id="conversion-risk",
            label="Oportunidades en riesgo",
            value=f"${sum(i.estimated_value for i in items if i.risk_level == 'high'):,} MXN",
            detail="22 leads",
            trend="+9%",
            sparkline=[5, 5, 6, 7, 9, 8, 12, 14, 13, 18],
            tone="good",
        ),
    ]
...
def _risk_radar(items: list[HandoffCommandItem]) -> list[RiskRadarItem]:
    ...
    return [
        RiskRadarItem(
            id="intent-failures",
            title="Fallas por intencion repetida",
            value=str(len([i for i in active if i.ai_confidence < 0.5])),
            detail="Intenciones con baja confianza",
            trend="+18% vs ayer",
            severity="high",
            sparkline=[4, 5, 7, 6, 8, 11, 10, 13, 12, 16],
        ),
        RiskRadarItem(
            id="sla-breach",
            title="Tendencia de brechas SLA",
            value=str(len([i for i in active if i.sla_status == "breached"])),
            detail="Casos fuera de objetivo",
            trend="+50% vs ayer",
            severity="critical",
            sparkline=[1, 2, 2, 3, 4, 3, 6, 7, 8, 9],
        ),
        RiskRadarItem(
            id="unassigned",
            title="Casos sin asignar",
            value=str(len([i for i in active if i.assigned_user_id is None])),
            detail="Requieren owner",
            trend="+83% vs ayer",
            severity="high",
            sparkline=[2, 3, 5, 4, 6, 8, 9, 11, 10, 13],
        ),
        RiskRadarItem(
            id="high-value",
            title="Leads de alto valor esperando",
            value=str(len([i for i in active if i.estimated_value >= 18000])),
            detail="$82,450 MXN potencial",
            trend="+4",
            severity="medium",
            sparkline=[2, 2, 4, 3, 5, 7, 6, 9, 8, 10],
        ),
        RiskRadarItem(
            id="low-confidence",
            title="Cluster baja confianza IA",
            value=str(len([i for i in active if i.ai_confidence < 0.4])),
            detail="Prom. 28%",
            trend="+9%",
            severity="high",
            sparkline=[3, 4, 5, 4, 7, 6, 8, 10, 9, 12],
        ),
        RiskRadarItem(
            id="missing-kb",
            title="Respuestas faltantes en KB",
            value=str(len([i for i in active if i.knowledge_gap_topic])),
            detail="Temas criticos",
            trend="+6",
            severity="medium",
            sparkline=[2, 2, 3, 4, 4, 6, 8, 7, 9, 12],
        ),
    ]
...
def _timeline_for(item: HandoffCommandItem, payload: dict | None = None) -> list[TimelineEvent]:
    ...
    events = [
        TimelineEvent(
            id=str(_stable_uuid(item.id, "created")),
            handoff_id=item.id,
            event_type="handoff_created",
            actor_type="ai",
            description=f"IA escalo por {item.handoff_reason}",
            metadata={"confidence": item.ai_confidence},
            created_at=item.created_at,
        ),
        TimelineEvent(
            id=str(_stable_uuid(item.id, "priority")),
            handoff_id=item.id,
            event_type="priority_scored",
            actor_type="system",
            description=f"Prioridad calculada en {item.priority_score}/100",
            metadata={"urgency": item.urgency},
            created_at=item.created_at + timedelta(seconds=15),
        ),
    ]
    if item.assigned_user_id:
        events.append(
            TimelineEvent(
                id=str(_stable_uuid(item.id, "assigned")),
                handoff_id=item.id,
                event_type="handoff_assigned",
                actor_type="human",
                actor_id=item.assigned_user_id,
                description=f"Asignado a {item.assigned_agent_name or item.suggested_agent_name}",
                metadata={},
                created_at=item.created_at + timedelta(minutes=1),
            )
        )
    if item.sla_status == "breached":
        events.append(
            TimelineEvent(
                id=str(_stable_uuid(item.id, "breach")),
                handoff_id=item.id,
                event_type="sla_breached",
                actor_type="system",
                description="SLA vencido, requiere atencion inmediata",
                metadata={"deadline": item.sla_deadline.isoformat()},
                created_at=item.sla_deadline,
            )
        )
    for raw in stored:
        try:
...
async def _get_real_handoff(
    session: AsyncSession, tenant_id: UUID, handoff_id: str
) -> HumanHandoff | None:
    try:
    ...
    return (
        await session.execute(
            select(HumanHandoff).where(
                HumanHandoff.id == parsed, HumanHandoff.tenant_id == tenant_id
            )
        )
    ).scalar_one_or_none()
...
async def _recommend_agent(
    item: HandoffCommandItem, agents: list[HumanAgent]
...
async def get_handoff_detail(
    handoff_id: str, _user: AuthedUser, tenant_id: TenantId, session: DbSession
    ...
    return HandoffDetailResponse(
        handoff=item, timeline=_timeline_for(item, row.payload if row else None)
    )
...
async def take_handoff(
    handoff_id: str, request: Request, user: AuthedUser, tenant_id: TenantId, session: DbSession
) -> HandoffCommandItem:
    ...
    if row is not None:
        ...
        payload["timeline"] = payload.get("timeline", []) + [
            TimelineEvent(
                id=str(_stable_uuid(handoff_id, "take", datetime.now(UTC).isoformat())),
                handoff_id=handoff_id,
                event_type="handoff_taken",
                actor_type="human",
                actor_id=str(user.user_id),
                description=f"{user.email} tomo el caso",
                metadata={},
        ...
        await session.execute(
            update(HumanHandoff)
            .where(HumanHandoff.id == row.id)
            .values(assigned_user_id=user.user_id, status="assigned", payload=payload)
        )
    ...
    return item.model_copy(
        update={
            "status": "assigned",
            "assigned_user_id": str(user.user_id),
            "assigned_agent_name": user.email.split("@")[0].replace(".", " ").title(),
        }
    )


@router.post("/{handoff_id}/assign", response_model=HandoffCommandItem)
async def assign_handoff_command(
    handoff_id: str,
    body: AssignCommandBody,
    request: Request,
    user: AuthedUser,
    tenant_id: TenantId,
    session: DbSession,
    ...
    if row is not None:
        ...
        payload["timeline"] = payload.get("timeline", []) + [
            TimelineEvent(
                id=str(_stable_uuid(handoff_id, "assign", datetime.now(UTC).isoformat())),
                handoff_id=handoff_id,
                event_type="handoff_assigned",
                actor_type="human",
                actor_id=str(user.user_id),
                description=f"Asignado a {assigned_name}",
                metadata={"assigned_user_id": body.user_id},
                created_at=datetime.now(UTC),
            ).model_dump(mode="json")
        ]
        try:
        ...
        await session.execute(
            update(HumanHandoff)
            .where(HumanHandoff.id == row.id)
            .values(assigned_user_id=parsed_user_id, status="assigned", payload=payload)
        )
        await session.commit()
        await _publish(
            request,
...
async def resolve_handoff_command(
    handoff_id: str,
    body: ResolveCommandBody,
    request: Request,
    user: AuthedUser,
    tenant_id: TenantId,
    session: DbSession,
    ...
    if row is not None:
        ...
        payload["timeline"] = payload.get("timeline", []) + [
            TimelineEvent(
                id=str(_stable_uuid(handoff_id, "resolve", resolved_at.isoformat())),
                handoff_id=handoff_id,
                event_type="handoff_resolved",
                actor_type="human",
                actor_id=str(user.user_id),
                description=f"Resuelto: {body.resolution_outcome}",
        ...
        await session.execute(
            update(HumanHandoff)
            .where(HumanHandoff.id == row.id)
            .values(status="resolved", resolved_at=resolved_at, payload=payload)
        )
        await session.commit()
        await _publish(
            request,
...
async def submit_feedback(
    ...
    if row is not None:
        ...
        payload["timeline"] = payload.get("timeline", []) + [
            TimelineEvent(
                id=str(_stable_uuid(handoff_id, "feedback", datetime.now(UTC).isoformat())),
                handoff_id=handoff_id,
                event_type="feedback_submitted",
                actor_type="human",
                actor_id=str(user.user_id),
                description=f"Feedback: {body.feedback_type}",
                metadata={"note": body.note},
                created_at=datetime.now(UTC),
            ).model_dump(mode="json")
        ]
        await session.execute(
            update(HumanHandoff).where(HumanHandoff.id == row.id).values(payload=payload)
        )
        await session.commit()
        await _publish(
            request,
            ...
            str(row.conversation_id),
            "handoff_feedback",
            {"handoff_id": handoff_id, "feedback_type": body.feedback_type},
        )
    return item.model_copy(
        update={
            "feedback_type": body.feedback_type,
            "knowledge_gap_topic": item.detected_intent
            if body.feedback_type == "knowledge_gap"
            else item.knowledge_gap_topic,
        }
    )
...
async def generate_reply_draft(
    ...
    if row is not None:
        ...
        payload["timeline"] = payload.get("timeline", []) + [
            TimelineEvent(
                id=str(_stable_uuid(handoff_id, "draft", datetime.now(UTC).isoformat())),
                handoff_id=handoff_id,
                event_type="reply_draft_generated",
                actor_type="ai",
                actor_id=str(user.user_id),
                description="Borrador IA generado para revision humana",
                metadata={},
                created_at=datetime.now(UTC),
            ).model_dump(mode="json")
        ]
    ...
    return DraftResponse(
        draft=draft,
        safety_notes=[
            "No se auto-envio al cliente.",
            "Validar datos fiscales, precio, stock o credito antes de usar.",
            "El humano debe revisar tono y politica.",
        ],
        source="mock",
    )
