...
class KbTestRun(Base):
    ...
    test_case_id: Mapped[UUID] = mapped_column(ForeignKey("kb_test_cases.id", ondelete="CASCADE"), index=True)
    ...
    failure_reasons: Mapped[list[str]] = mapped_column(ARRAY(Text), default=list, server_default="{}")
