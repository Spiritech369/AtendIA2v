...
class Appointment(Base):
    ...
    appointment_type: Mapped[str] = mapped_column(
        String(30), default="follow_up", server_default="follow_up"
    )
    ...
    timezone: Mapped[str] = mapped_column(
        String(80), default="America/Mexico_City", server_default="America/Mexico_City"
    )
    ...
    down_payment_confirmed: Mapped[bool] = mapped_column(
