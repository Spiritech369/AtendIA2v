...
class KbTestCase(Base):
    ...
    expected_keywords: Mapped[list[str]] = mapped_column(ARRAY(Text), default=list, server_default="{}")
    forbidden_phrases: Mapped[list[str]] = mapped_column(ARRAY(Text), default=list, server_default="{}")
    ...
    expected_action: Mapped[str] = mapped_column(String(20), default="answer", server_default="answer")
