...
class Customer(Base):
    ...
    sla_status: Mapped[str] = mapped_column(String(20), default="on_track", server_default="on_track")
    ...
    documents_status: Mapped[str] = mapped_column(String(30), default="missing", server_default="missing")
    last_ai_action_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
...
class CustomerScore(Base):
    ...
    conversation_engagement_score: Mapped[int] = mapped_column(Integer, default=0, server_default="0")
