...
class TenantCatalogItem(Base):
    ...
    __table_args__ = (UniqueConstraint("tenant_id", "sku", name="uq_tenant_catalogs_tenant_sku"),)
...
class TenantToolConfig(Base):
    ...
    __table_args__ = (UniqueConstraint("tenant_id", "tool_name", name="uq_tenant_tools_config"),)
