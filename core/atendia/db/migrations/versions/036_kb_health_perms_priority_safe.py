...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "can_quote_prices", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
        ...
        sa.Column(
            "escalate_on_conflict", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
    ...
    op.create_index(
        "uq_kb_agent_perms", "kb_agent_permissions", ["tenant_id", "agent"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "allow_direct_answer", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
        sa.Column(
    ...
    op.create_index(
        "ix_kb_priority_tenant_agent", "kb_source_priority_rules", ["tenant_id", "agent"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "block_invented_prices", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
        sa.Column(
            "block_invented_stock", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
        sa.Column(
            "risky_phrases",
            postgresql.JSONB(astext_type=sa.Text()),
