...
| Frontend `pnpm exec vitest run` | 19 files, 90 tests passed | Incluye `auth-guards` (4), `RoleGate` (4), `turnStory` (10), `FlowModeBadge` (4), `TurnStoryView` (8), `useCustomerAttrs` (4), `EditableDetailRow` (8), `AddCustomAttrDialog` (8), `menu-config` (6), `useNavBadges` (2), `sidebar-store` (5), `SidebarItem` (9), `SidebarGroup` (4). |
