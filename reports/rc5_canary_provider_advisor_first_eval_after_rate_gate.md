...
- provider_latency_p50: `3281`
- provider_latency_p95: `7097`
- provider_latency_p99: `9084`
- cases_passed: `39/40`
- naturalidad_avg: `4.98`
- repeated_question_rate: `0.005`
...
- progress_guard_blocks_total: `6`
- progress_guard_block_rate: `0.03`
- progress_guard_sanitized_messages_count: `6`
- generic_sanitizer_fallback_rate: `0.0`
- answer_relevance_rate: `0.865`
- documents_request_answered_rate: `0.8333`
- conversation_progress_rate: `0.995`
...
| case_05 | base | pass | nuevos | 5.0 | False | False | ok |
...
| adv_05 | adversarial | fail | nuevos | 4.1 | True | False | repeated_question_or_exact_response_detected |
| adv_06 | adversarial | pass | nuevos | 5.0 | False | False | ok |
| adv_07 | adversarial | pass | nuevos | 5.0 | False | False | ok |
...
| adv_15 | adversarial | pass | nuevos | 5.0 | False | False | ok |
...
- `case_01`: Para el plan de nómina, necesitas presentar tu INE y un comprobante de domicilio. Si necesitas más información, házmelo saber.
- `case_02`: Perfecto, ahora que tienes los documentos, podemos proceder con el siguiente paso. ¿Te gustaría que revisemos la cotización ahora?
- `case_03`: Te doy continuidad con lo que ya tenemos en la conversacion.
- `case_04`: Procederé a confirmar la cotización del U5 150 CC y te informaré en breve. Gracias por tu paciencia.
...
- `case_07`: Para Adventure Elite 150 CC con Sin Comprobantes, el enganche es de $10,080 y los pagos son de $1,120 por 36 pagos. ¿Te gustaría que te explique los documentos que necesitas?
- `case_08`: Aún no tengo la cotización confirmada. Estoy en proceso de verificar los requisitos específicos para el crédito de la R4 y te mantendré informado.
- `case_09`: Te conectaré con Francisco ahora mismo para que te ayude con la cotización de la Adventure.
- `case_10`: Te doy continuidad con lo que ya tenemos en la conversacion.
